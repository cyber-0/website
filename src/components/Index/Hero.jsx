                ...
                <div className="relative isolate px-6 pt-14 lg:px-8">
                    ...
                    <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                        <div className="text-center  text-base">
                            <img src='/logo.png' className="w-32 h-32 mx-auto" alt='logo' />
                            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl mt-4">
                                iumProject
                            </h1>
                            <p className="mt-6 text-lg leading-8">
                                We serve you with great Minecraft setups, plugin configurations, web solutions and more! Because we are beyond blocks and limits!
                            </p>
                            <svg
